...
* Implemented **increment and decrement functionality** for product quantities with event handlers.
* Applied **conditional rendering and styling** for dark/light theme switching.
* Updated **array and object state immutably** using map() and the spread operator
